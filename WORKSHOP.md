...
4. Turn on thinking (ctrl+t).
5. Start with the raplphex-plan skill (`/skills`), for example: `/raplphex-plan Let's create a plan to implement multiplayer pacman client. Client specs are in docs/specs`. 
...
11. Once ralphex is done, we are ready to play! Check `README.md` or ask `opencode` "I am ready to play, how to start towards `pacman-server.mschedrin.workers.dev` server?"
